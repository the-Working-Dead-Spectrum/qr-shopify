...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'create-partner','title' => 'Créer un partenaire','maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'create-partner','title' => 'Créer un partenaire','maxWidth' => 'md']); ?>
    <form method="POST" action="<?php echo e(route('admin.partners.store')); ?>" x-data="{ loading: false }" 
...
<?php endif; ?><?php /**PATH C:\Users\arist\Documents\websites\qr-shopify-main\resources\views/admin/partners/_create_modal.blade.php ENDPATH**/ ?>