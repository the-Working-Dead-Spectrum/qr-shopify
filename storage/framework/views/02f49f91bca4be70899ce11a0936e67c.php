...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto space-y-xl" id="dashboard-content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-lg">
            <?php echo $__env->make('components.kpi-card', [
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-lg">
            ...
            <div class="lg:col-span-2 bg-surface-container-lowest p-lg rounded-xl border border-outline-variant shadow-sm flex flex-col h-[500px]">
                <?php echo $__env->make('components.chart', [
                    'chartData' => $chartData ?? [
            ...
            <div class="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-sm flex flex-col h-[500px]">
                <?php echo $__env->make('components.activity-feed', [
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
            ...
            <div class="bg-primary text-white p-lg rounded-xl flex flex-col justify-between overflow-hidden relative group">
                ...
                <a href="<?php echo e(route('admin.support')); ?>" class="mt-lg relative z-10 bg-white text-primary px-lg py-sm rounded-lg font-bold w-fit hover:bg-opacity-90 transition-all active:scale-95">
                    Support 24/7
                </a>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-lg flex gap-md">
                        <div class="text-center px-lg border-r border-outline-variant">
                            <p class="text-headline-md font-bold text-primary"><?php echo e($shopifyData['partnersParis'] ?? 42); ?></p>
                            <p class="text-[10px] text-secondary uppercase font-bold tracking-widest">Paris</p>
                        </div>
                        
                        <div class="text-center px-lg border-r border-outline-variant">
                            <p class="text-headline-md font-bold text-primary"><?php echo e($shopifyData['partnersLyon'] ?? 18); ?></p>
                            <p class="text-[10px] text-secondary uppercase font-bold tracking-widest">Lyon</p>
                        </div>
                        
                        <div class="text-center px-lg">
                            <p class="text-headline-md font-bold text-primary"><?php echo e($shopifyData['partnersMarseille'] ?? 12); ?></p>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function updateRealTimeData() {
            fetch('<?php echo e(route("admin.api.dashboard-data")); ?>')
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\arist\Documents\websites\qr-shopify-main\resources\views/admin/dashboard_new.blade.php ENDPATH**/ ?>