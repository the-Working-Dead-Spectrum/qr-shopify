...
<div class="flex-1 relative">
    ...
    <div class="absolute inset-0 flex items-end justify-between px-md">
        ...
        <?php $__currentLoopData = $chartData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-8 bg-<?php echo e($data['color']); ?> rounded-t-sm" style="height: <?php echo e($data['height']); ?>%"></div>
...
</div><?php /**PATH C:\Users\arist\Documents\websites\qr-shopify-main\resources\views/components/chart.blade.php ENDPATH**/ ?>